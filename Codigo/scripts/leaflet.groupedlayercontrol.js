...
L.Control.GroupedLayers = L.Control.extend({
 ...
 _initLayout: function () {
    ...
    // Adiciona a classe leaflet-control-layers-expanded para expandir por padrão
    ...
    // Adicione uma classe CSS para permitir a rolagem
    form.className += ' leaflet-control-layers-scrollbar';
